...
public class ProductController  extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            else if (req.getServletPath().equals("/goToCart")){
                showCartPage(req,resp);}

            else if (req.getServletPath().equals("/validate")){
...
//            try {
//                productRepository.delete((Product) req.getParameter("id")));
//            }
    }
    ...
    private void showValidationPage(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            getServletContext().getRequestDispatcher("/validatoion.jsp").forward(req, resp);
    }
}
